<?php
  ...
  $sth = $conn->prepare('SELECT count(*) as total from productos');
  $sth->execute();
  $resultado = $sth->fetch(PDO::FETCH_ASSOC);
  $productos=$resultado;
  $sth1 = $conn->prepare('SELECT count(*) as total from clientes');
  $sth1->execute();
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Laboratorio Pharmavet</title>
...
<body>
	...
	<section class="full-width pageContent">
		<section class="full-width text-center" style="padding: 40px 0;">
			<h3 class="text-center tittles">SISTEMA DE INVENTARIO PHARMAVET</h3>
			<!-- Tiles -->
	...
	<?php else: ?>
      <h1>Ingrese Con su usuario y contraseña</h1>
